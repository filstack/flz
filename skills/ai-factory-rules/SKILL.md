---
name: ai-factory-rules
description: Add project-specific rules and conventions to .ai-factory/RULES.md. Each invocation appends new rules. These rules are automatically loaded by /ai-factory-implement before execution. Use when user says "add rule", "remember this", "convention", or "always do X".
...
Add short, actionable rules and conventions for the current project. Rules are saved to `.ai-factory/RULES.md` and automatically loaded by `/ai-factory-implement` before task execution.
...
```
/ai-factory-rules Always use DTO classes instead of arrays
```
...
> Short, actionable rules and conventions for this project. Loaded automatically by /ai-factory-implement.
