...
### Mode 3: Check Progress (`/ai-factory-roadmap check`)

Automated scan — analyze the codebase and mark completed milestones without interactive questions.

**Requires** `.ai-factory/ROADMAP.md` to exist. If it doesn't — tell the user to run `/ai-factory-roadmap` first.
