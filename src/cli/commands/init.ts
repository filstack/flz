...
export async function initCommand(): Promise<void> {
  ...
  if (await configExists(projectDir)) {
    ...
    console.log('Use "flz update" to update existing skills.\n');
  }
  ...
  try {
    ...
    const installedSkills = await installSkills({
      ...
      stack: null, // Stack-specific skills generated by /flz in Claude
    ...
    if (welcomeMessage) {
      ...
      console.log(chalk.dim('  2. Run /flz to analyze project and generate stack-specific skills'));
      console.log(chalk.dim('  3. Use /flz.feature to start new features, /flz.commit to commit'));
    }
    console.log('');
